# GOCUI - Go Console User Interface q
...
* [lazygit](https://github.com/nilxdev/lazygit): simple terminal UI for git commands.
* [lazydocker](https://github.com/nilxdev/lazydocker): The lazier way to manage everything docker.
